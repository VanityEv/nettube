...
const Player = (props: Props) => {
  ...
  return (
    <Box display="flex" flexDirection="column" alignItems="center">
      <Box width="90%" display="flex" flexDirection="column" alignItems="center" paddingBottom={3}>
        {!isLoading && (
          <iframe
            width="100%"
      ...
      <Likes onLikeClick={onLikeClick} liked={liked} count={likesCount} width="90%" justifyContent="flex-end" />
